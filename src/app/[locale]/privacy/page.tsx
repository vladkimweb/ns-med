...
const PrivacyPolicyPage: NextPage = () => {
  return (
    <div className=" relative container mx-auto px-4 py-8">
      <Head>
        <title>Политика конфиденциальности | NS Medical</title>
      ...
      <section className="prose prose-lg max-w-4xl mx-auto">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to NS Group, 김해시 호계로 438번길 16-1(부원동).</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to NS Med Travel, accessible from <a href="https://ns-grp.com/medtravel/" rel="external nofollow noopener" target="_blank">https://ns-grp.com/medtravel/</a></p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: Nsgroup1809@gmail.com</li>
        </ul>
      </section>
    </div>
  );
