...
export function Hero() {
  ...
  return (
    <div className="relative w-full min-h-[calc(100vh)] grid place-items-center">
      {/* Фоновое изображение */}
      ...
      <div className="top-[64px] relative z-10 container mx-auto h-full grid grid-cols-1 items-center text-white">
